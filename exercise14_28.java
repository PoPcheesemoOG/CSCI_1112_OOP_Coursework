...
public class exercise14_28 extends Pane {
		...
		public exercise14_28() {
			setCurrentTime();
			paintClock();
		}

		public exercise14_28(int hour, int minute, int second) {
			this.hour = hour;
			this.minute = minute;
			this.second = second;
			paintClock();
		...
		protected void paintClock() {
			...
			Text t10 = new Text(centerX - clockRadius + 2, centerY + 4, "10");
			...
			Text t11 = new Text(centerX - clockRadius + 1, centerY + 3, "11");
			Text t5 = new Text(centerX + clockRadius - 60, centerY + 83, "5");
			Text t8 = new Text(centerX - 1, centerY + clockRadius - 5, "8");
